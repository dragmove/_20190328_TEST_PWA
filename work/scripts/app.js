// TODO: https://developers.google.com/web/fundamentals/codelabs/your-first-pwapp/?hl=ko#_25
...
(function() {
  ...
  if (app.selectedCities) {
    ...
    // TODO: A real app in this scenario could guess the user's location via IP lookup and then inject that data into the page.
    app.updateForecastCard(initialWeatherForecast);
    ...
    // TODO: Don't use local storage on a real app
    app.saveSelectedCities();
  }
